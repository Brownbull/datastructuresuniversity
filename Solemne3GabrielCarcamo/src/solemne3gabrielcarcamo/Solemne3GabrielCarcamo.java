 ...
 */
package solemne3gabrielcarcamo;
 ...
 * @author 172493726
 */
public class Solemne3GabrielCarcamo {
    ...
    public static void main(String[] args) {
        ...
        Persona p1= new Persona("11334056,José,Álvarez,M,C,21/10/1971");
            ...
            Base<Persona> p = d.get(r.getNumero());  // usa solol numero antes de digito verificador
            if (p!=null){
            ...
            r = new Rut(79733720);
            p = d.get(r.getNumero()); // usa solol numero antes de digito verificador
            if (p!=null){
                System.out.println(p.toString());
            }
            else{
